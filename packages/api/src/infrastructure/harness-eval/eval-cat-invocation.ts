...
const PUBLISH_VERDICT_GIT_RESULT_INSTRUCTIONS = `
...
${PUBLISH_VERDICT_GIT_RESULT_INSTRUCTIONS}
`;
...
Bundle contains snapshot.json + attribution.json + provenance.json, including sha256 provenance for the replay inputs.
