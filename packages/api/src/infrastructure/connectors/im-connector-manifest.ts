 ...
 *
 * F231 KD-15: uses shared ConfigField types + parseConfigFields() — same
...
export interface ConnectorManifest {
  ...
  themeColor: string;
  docsUrl: string;
  /** F231: ConfigField[] includes value + operation fields; filter with isValueField/getValueFields for env paths */
  config: ConfigField[];
