...
export const PLUGIN_CONTRACT_PACKAGE_VERSION = '0.1.0-beta.13' as const;
...
export const PLUGIN_MANIFEST_CONTRACT_VERSIONS = [PLUGIN_CONTRACT_VERSION, PLUGIN_CONTRACT_PACKAGE_VERSION] as const;
