...
export const PLUGIN_CONTRACT_PACKAGE_VERSION = '0.1.0-beta.21' as const;
...
/** Train C1 packages already admitted under the previous beta line remain installed. */
export const PREVIOUS_PLUGIN_MANIFEST_CONTRACT_VERSION = '0.1.0-beta.20' as const;
...
export const PLUGIN_MANIFEST_CONTRACT_VERSIONS = [
  ...
  PREVIOUS_PLUGIN_MANIFEST_CONTRACT_VERSION,
