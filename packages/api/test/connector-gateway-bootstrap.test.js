...
describe('ConnectorGateway Bootstrap', () => {
  ...
  // ── F240 R2-P2: external plugin metadata registered even when unconfigured ──

  it('F240 R2-P2: registers external plugin metadata before isConfigured check (bootstrap path)', async () => {
    ...
    writeFileSync(
      ...
      `export default {
        ...
        definition: {
          ...
          icon: { type: 'png', src: '/test.png' },
          themeColor: '#FF0000',
          description: 'F240 R2 regression probe',
        },
