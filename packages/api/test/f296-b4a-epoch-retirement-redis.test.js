...
describe(
  'F296 B4a: epoch-fenced presentation generation retirement',
  ...
  () => {
    ...
    before(async () => {
      assertRedisIsolationOrThrow(REDIS_URL, 'F296 B4a: epoch-fenced presentation generation retirement');
