    ...
    return (
      <div className="space-y-2" data-testid="feishu-connected">
        <div className="flex items-center gap-2 rounded-lg border border-conn-green-ring bg-conn-green-bg px-3 py-2.5">
          ...
          <span className="text-sm font-medium text-conn-green-text">Feishu connected</span>
          <button
            type="button"
  ...
  return (
    <div className="space-y-3" data-testid="feishu-qr-panel">
      ...
      {qrState === 'waiting' && qrUrl && (
        <div className="flex flex-col items-center gap-3 rounded-xl bg-[var(--console-card-bg)] p-4 shadow-[0_8px_22px_rgba(43,33,26,0.04)]">
