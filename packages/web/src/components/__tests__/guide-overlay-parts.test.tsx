...
describe('HUDActions', () => {
  it('shows skip button when canSkip is true', () => {
    const html = renderToStaticMarkup(
      <HUDActions onPrev={noop} onNext={noop} onSkip={noop} onExit={noop}
        hasPrev={false} hasNext={true} isComplete={false} canSkip={true} />,
    );
  ...
  it('hides skip button when canSkip is false', () => {
    const html = renderToStaticMarkup(
      <HUDActions onPrev={noop} onNext={noop} onSkip={noop} onExit={noop}
        hasPrev={false} hasNext={true} isComplete={false} canSkip={false} />,
    );
  ...
  it('shows prev button when hasPrev is true', () => {
    const html = renderToStaticMarkup(
      <HUDActions onPrev={noop} onNext={noop} onSkip={noop} onExit={noop}
        hasPrev={true} hasNext={true} isComplete={false} canSkip={true} />,
    );
  ...
  it('shows complete button when isComplete', () => {
    const html = renderToStaticMarkup(
      <HUDActions onPrev={noop} onNext={noop} onSkip={noop} onExit={noop}
        hasPrev={false} hasNext={false} isComplete={true} canSkip={true} />,
    );
  ...
  it('always shows exit button', () => {
    const html = renderToStaticMarkup(
      <HUDActions onPrev={noop} onNext={noop} onSkip={noop} onExit={noop}
        hasPrev={false} hasNext={false} isComplete={false} canSkip={false} />,
    );
