  ...
  return (
    <div className="flex gap-2 px-4 pt-2 md:hidden">
      ...
      <button
        ...
        className={`${btnBase} ${
          whisperMode
            ...
            : 'text-cafe-secondary bg-cafe-surface border-cafe hover:border-[var(--semantic-warning)] hover:text-conn-amber-text'
        }`}
      >
      ...
      <button
        ...
        disabled={disabled || sendDisabled}
        className={`${btnBase} text-cafe-secondary bg-cafe-surface border-cafe hover:border-[var(--semantic-info)] hover:text-[var(--semantic-info)]`}
      >
        <svg className="w-4 h-4" viewBox="0 0 20 20" fill="currentColor">
