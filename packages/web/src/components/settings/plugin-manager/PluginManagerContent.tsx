...
export function PluginManagerContent({
  ...
  return (
    <section data-testid="plugin-manager" className="space-y-3.5">
      ...
      <div className="grid gap-3.5 lg:grid-cols-[minmax(17rem,0.82fr)_minmax(0,1.5fr)]">
        <div data-mobile-panel="list" className={`${mobileDetailOpen ? 'hidden' : 'block'} min-w-0 space-y-2 lg:block`}>
          <div>
        ...
        <div
          ...
          className={`${mobileDetailOpen ? 'block' : 'hidden'} min-w-0 space-y-2 lg:block`}
        >
          <button
            type="button"
