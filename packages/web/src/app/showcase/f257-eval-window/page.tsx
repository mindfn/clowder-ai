 ...
 *
 * Review harness (sol R1 P2-2): reproduces the original 18-vs-0 incident in
 * ONE composed viewport — chain badge `tracing(18)` + eval detail showing
 ...
 * (or capture via packages/web/scripts/capture-f257-eval-window.mjs)
 */
...
const legacyEpoch = {
  ...
  eval: {
    ...
    violationCount: 0,
    evaluatedAt: EVAL_WINDOW.endMs,
    // Legacy pre-6c cache entry: provenance fields missing → fail-visible unknown.
    evalWindow: null,
    ...
    <div className="mx-auto max-w-5xl space-y-8 p-6">
      <div>
        ...
        <p className="mt-2 text-sm text-cafe-secondary">
          ...
          <strong>该 judgment 自己的历史评估窗口</strong> + 分母 fired-count。
        </p>
      </div>
