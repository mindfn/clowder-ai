...
export const publishVerdictTools = [
  defineTool({
    ...
    description:
      ...
      'GOTCHA: wired domains include eval:a2a plus replayable capability-wakeup, memory, SOP, task-outcome, friction, anchor-first, freshness, QC, design-gate, and Harness Ledger generators. Unregistered or runtime-unwired domains return 501. ' +
