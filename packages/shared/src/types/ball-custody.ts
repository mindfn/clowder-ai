...
// ---------------------------------------------------------------------------
// Event kinds（全 18 种，每种在 state-machine 转移表必有一行——INV-10 穷举钉死）
// Phase B 13 种 + Phase C 3 安乐死 + Phase P 1 wakeWhen kind + F257 LI-005 1 void_ack
// ---------------------------------------------------------------------------
...
export type BallEventKind =
  ...
  | 'ball.void_ack' // F257 LI-005: A2A 接球但无持久触发器绑定（球静默死亡）
