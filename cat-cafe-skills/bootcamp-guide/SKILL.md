...
根据用户描述，**正常地**实现一个简单版本。可以是：
- 在 worktree 中创建一个简单的 HTML/React 页面
- 展示代码 + 截图 or 预览链接

**不需要故意犯错**。正常实现即可——任何代码在 review 时都有改进空间，第二只猫自然会发现可以做得更好的地方。
...
> "不过我觉得可能还能做得更好…… 按照我们的工程实践，应该找另一位猫猫来审审看。
> 但是现在团队只有我一个猫——要不我们给团队加一位新成员？有人监督我干活会更靠谱！"
