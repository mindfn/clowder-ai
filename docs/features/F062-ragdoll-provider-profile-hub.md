...
> **Status**: done → **superseded by F136/F340** | **Owner**: 三猫
> **Completed**: 2026-03-05
>
> ⚠️ **Superseded**: 本 feature 的 provider-profiles 系统已被 F136 统一配置架构（`accounts.json` + `credentials.json`）和 F340 accounts 重构取代。当前实现见 F136 文档。保留本文档作为历史设计记录。
