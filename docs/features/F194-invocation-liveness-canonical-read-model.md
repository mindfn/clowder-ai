...
| R18 | "我at了三只猫 但是你看我thread 从这个thread 切到别的然后切换回来只剩两只？！ why" (2026-05-19 08:40) | AC-Z31 | ideate queue hydrate 保留本轮 full targetCats，只用 `/queue.activeInvocations` 更新 active slots / streaming 状态 | [x] (Phase Z12 hotfix) |
| R19 | "又出现重复气泡了！ Maine Coon猫！" (2026-05-19 19:13) | AC-Z32 | live parent-only stream chunk 在当前 turn 已知时按 turn 绑定，不再回收旧 same-parent finalized bubble | [x] (Phase Z13 hotfix) |
