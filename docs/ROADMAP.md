...
| F257 | Harness Ledger — 段试验品/锅账自治环（#23 observation、#24 generator、#33 event trigger、#34 approval executor、#35 trace bridge + judgment、#36 lifeline、Phase D lifecycle/operations、#38 LI-001 均已合入；Phase D 隔离验收绿；现场 Console 闭环、首个完整五环、LI-005 与 Phase E 待完成） | in-progress | Ragdoll (Fable) + Ragdoll (Opus-4.6) + Maine Coon (terra/sol) | internal (co-creator 2026-07-08 共创邀请「最适合你们的运行环境和身体应由你们自己构建」) | [F257](features/F257-harness-ledger.md) |
| F258 | Desktop In-App Update — 应用内检查更新 + 原地升级（无签名约束版）| approved — ready for dev | 布偶猫（Opus）| internal | [F258](features/F258-desktop-in-app-update.md) |
