...
| F258 | Plugin Messaging Domain — K-1 messaging 域收敛（canonical envelope + handle binding + durable event cursor + appendElements + idempotency ledger） | draft | community @mindfn + maintainers | internal (plugins v0 roadmap) | [F258](features/F258-plugin-messaging-domain.md) |
