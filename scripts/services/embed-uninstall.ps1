...
# Legacy path cleanup (pre-a34ab1f2): venvs lived under $HOME/.cat-cafe.
# resolveVenvPath in service-registry falls back to this legacy path, so
# leaving residue there masks uninstall in venv-probe detection. Wipe
# both paths.
$VenvDirLegacy = Join-Path $HOME ".cat-cafe\embed-venv"
