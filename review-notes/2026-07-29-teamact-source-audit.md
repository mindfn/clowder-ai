...
| A2A v1.0.0 是独立 agent 系统间的互操作协议，Task 支持异步、订阅 / push / cancel 和 HITL 中断态 | A2A Project, [v1.0.0 specification](https://a2a-protocol.org/v1.0.0/specification/) | formal specification, v1.0.0 / A2A | 正式一手规范；基金会治理；非论文；版本明确；对象匹配 | `use` | `[一手｜formal specification｜v1.0.0｜A2A Task / HITL｜高]` |
