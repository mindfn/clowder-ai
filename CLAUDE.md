...
5. **Port Boundary** — Ports configured in `.env` (`FRONTEND_PORT` / `API_SERVER_PORT`) are reserved for the running instance. Dev servers must use other ports to avoid collision.
